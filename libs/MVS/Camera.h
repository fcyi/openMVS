...
{
public:
	KMatrix K; // 内参矩阵，the intrinsic camera parameters (3x3)
	RMatrix R; // 旋转矩阵，rotation (3x3) and
	CMatrix C; // 相机中心在世界坐标系中的位置，translation (3,1), the extrinsic camera parameters
