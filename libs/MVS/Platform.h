...
public:
	...
	// 结构体，描述相机位姿// 结构体，描述相机位姿
	struct Pose {
		RMatrix R; // 旋转矩阵世界坐标系到相机坐标系，platform's rotation matrix
		CMatrix C; // 相机原点在世界坐标系中的位置，platform's translation vector in the global coordinate system
		#ifdef _USE_BOOST
